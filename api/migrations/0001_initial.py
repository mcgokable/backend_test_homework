# Generated by Django 3.0.5 on 2021-02-26 13:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'User'), ('moderator', 'Moderator'), ('admin', 'Admin')], default='user', max_length=10, verbose_name='Степени доступа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='conf', to=settings.AUTH_USER_MODEL, verbose_name='Почта')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
